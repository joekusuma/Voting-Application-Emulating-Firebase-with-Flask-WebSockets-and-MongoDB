...
polls = [    
    {"id": 1, "title": "What is your favorite color?", "description": "Choose one of the following colors.", "options": ["Red", "Green", "Blue"], "votes": [3, 2, 1]},
    {"id": 2, "title": "What is your favorite food?", "description": "Choose one of the following foods.", "options": ["Pizza", "Burgers", "Tacos"], "votes": [5, 3, 2]},
    {"id": 3, "title": "What is your favorite movie?", "description": "Choose one of the following movies.", "options": ["Star Wars", "The Godfather", "The Shawshank Redemption"], "votes": [1, 4, 5]}
]
...
def create_poll():
    if request.method == "POST":
        ...
        polls.append({"title": title, "description": description})
